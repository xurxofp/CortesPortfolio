				...
				foreach($sets['photosets']['photoset'] as $set)
				{
					$display .= '<div class="col-xs-6 col-sm-3 col-md-2">
										<a href="?id='.$set['id'].'" class="thumbnail photoset">
	      								<img src="https://farm'.$set['farm'].'.staticflickr.com/'.$set['server'].'/'.$set['primary'].'_'.$set['secret'].'_q.jpg">
	      								<div class="caption">
	      									'.$set['title']['_content'].'
	      								</div>
	      							</a>
		...
		if($sets['stat'] == 'ok' AND is_array($sets['photoset']['photo']))
		{
			...
			foreach($sets['photoset']['photo'] as $set)
			{
				...
				$display .= '<div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
									<a href="https://farm'.$set['farm'].'.staticflickr.com/'.$set['server'].'/'.$set['id'].'_'.$set['secret'].'_b.jpg" class="thumbnail" title="'.$title.'" data-gallery>
      								<img class="lazy" data-original="https://farm'.$set['farm'].'.staticflickr.com/'.$set['server'].'/'.$set['id'].'_'.$set['secret'].'_q.jpg" width="150" height="150">
      							</a>
      						</div>';
